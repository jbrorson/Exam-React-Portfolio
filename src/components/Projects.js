          ...
          <div className="flex flex-col md:flex-row md:max-w-4xl max-w-sm sm:w-full mx-auto bg-white my-5 rounded-default sm:rounded-0 shadow-lg over-hidden">
            ...
            <div className="p-4">
              <div className="h-full flex flex-col justify-between">
                ...
                <p className="m-2 text-gray-700 text-sm md:text-base">B-E-V is a Stockmarket dashboard app. During the investment approach, there are many questions that rises whether to sell, buy, or hold stocks.</p>
                <div>
                  <div>
                    <Modal />
          ...
          <div className="flex flex-col md:flex-row md:max-w-4xl max-w-sm mx-auto bg-white my-5 rounded-default sm:rounded-0 shadow-lg overflow-hidden">
            ...
            <div className="p-4">
              <div className="h-full flex flex-col justify-between">
                ...
                <p className="m-2 text-gray-700 text-sm md:text-base">This website was created for a very important purpose - to help new students with their onboarding jurney.</p>
                <div>
                  <div>
                    <Modal />
                  </div>
